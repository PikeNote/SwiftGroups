...
object EventsAPI {
    ...
    suspend fun grabEvents(grabEntire : Boolean = false) : List<CGEvent> {
        ...
        var url = "https://community.case.edu/mobile_ws/v17/mobile_events_list?range=0&limit=200&filter4_contains=OR&timestamp=${timestamp.epochSeconds}&filter8=${dateToday.dayOfMonth}%20${dateToday.format(monthShortFormat)}%20${dateToday.year}&filter4_notcontains=OR&order=undefined&search_word=&&1726272567036"
